...
class NotifyHelper {
  ...
  tz.TZDateTime _nextInstanceOfTenAM(
    ...
    print('formattedDateLocal =======$formattedDateLocal');
    print('now =======$now');
    ...
    scheduledDate = _afterReimnd(remind, scheduledDate);
    ...
    print('scheduledDate final=======$scheduledDate');
  ...
  //   // var dataIn12 = DateFormat('yyyy-MM-dd hh:mm:ss').format(now);
  //   var formattedDate = DateFormat.yMd().parse(date);
  //   final tz.TZDateTime formattedDateLocal =
  //       tz.TZDateTime.from(formattedDate, tz.local);
  //   tz.TZDateTime scheduledDate = tz.TZDateTime(
  ...
  //   print('===================2=========================');
  //   if (scheduledDate.isBefore(now)) {
  //     print('nowwwwwwwwwwwwwwwwwwwwww $now');
  //     print('===================3=========================');
  ...
  tz.TZDateTime _afterReimnd(int remind, tz.TZDateTime scheduledDate) {
    if (remind == 0) {
 ...
 */
    ...
    // flutterLocalNotificationsPlugin.show(id, title, body, not,
    //     payload: payload);
  }
